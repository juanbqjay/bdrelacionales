...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-04-2026 a las 17:00:46
...
(1, 1, 2, '¡Exactamente! Madeleine.', '2026-04-15 16:56:53');
...
(1, 1, 'Odio los lunes', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTX6_Y0pGVp3jenFEySyA5SEoLUzNiBRQkQw&s', '2026-04-15 07:52:49', 32);
...
(1, 'its_onlymads', 'madeleinecgu@gmail.com', 'God´s version\r\nsin  / mex\r\n8´teen\r\ntu deportista favorita', '2023-02-13'),
(2, 'jaybqjp', 'juanbojorquezquintero@gmail.com', 'aromantic icon', '2022-06-25');
...
--
ALTER TABLE `hashtags`
  MODIFY `hashtag_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
